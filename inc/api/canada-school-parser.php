...
add_action('rest_api_init','___sip__register_api_endpoint_for_single_canada_school_parser');

function ___sip__register_api_endpoint_for_single_canada_school_parser(){
    register_rest_route( 'school-insiders/v1' , '/canada-school' , array(
        'methods' => 'POST',
        'callback' => '___sip__single_canada_scholl_parser',
        'permission_callback' => '__return_true',
    ));
}

function ___sip__single_canada_scholl_parser( WP_REST_Request $request){
